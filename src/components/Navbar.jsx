        ...
        <div>
            <div className="navbar bg-base-100 h-24">
                <div className="navbar-start">
                    ...
                    <Link to="/" className="btn btn-ghost normal-case text-xl"><img className="w-16" src={logo} alt="logo" /></Link>
                </div>
